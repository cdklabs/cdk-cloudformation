...
/**
 * A CloudFormation `AWSSamples::Ec2ImageIdCheckSsm::Hook`
 *
 * @cloudformationResource AWSSamples::Ec2ImageIdCheckSsm::Hook
 * @stability external
...
export class CfnHook extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "AWSSamples::Ec2ImageIdCheckSsm::Hook";
  ...
  /**
   * Create a new `AWSSamples::Ec2ImageIdCheckSsm::Hook`.
   *
