...
/**
 * A CloudFormation `AWSSamples::Ec2SsmSmOnly::Hook`
 *
 * @cloudformationResource AWSSamples::Ec2SsmSmOnly::Hook
 * @stability external
...
export class CfnHook extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "AWSSamples::Ec2SsmSmOnly::Hook";
  ...
  /**
   * Create a new `AWSSamples::Ec2SsmSmOnly::Hook`.
   *
