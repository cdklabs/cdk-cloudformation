...
/**
 * A CloudFormation `AWSSamples::RdsEncrypt::Hook`
 *
 * @cloudformationResource AWSSamples::RdsEncrypt::Hook
 * @stability external
...
export class CfnHook extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "AWSSamples::RdsEncrypt::Hook";
  ...
  /**
   * Create a new `AWSSamples::RdsEncrypt::Hook`.
   *
