...
/**
 * A CloudFormation `AWSSamples::S3BlockPublicAccess::Hook`
 *
 * @cloudformationResource AWSSamples::S3BlockPublicAccess::Hook
 * @stability external
...
export class CfnHook extends cdk.CfnResource {
  ...
  */
  public static readonly CFN_RESOURCE_TYPE_NAME = "AWSSamples::S3BlockPublicAccess::Hook";
  ...
  /**
   * Create a new `AWSSamples::S3BlockPublicAccess::Hook`.
   *
