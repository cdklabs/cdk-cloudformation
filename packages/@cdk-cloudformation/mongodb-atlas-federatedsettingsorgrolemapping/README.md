...
* Issues related to `MongoDB::Atlas::FederatedSettingsOrgRoleMapping` should be reported to the [publisher](https://github.com/aws-cloudformation/aws-cloudformation-rpdk.git).
