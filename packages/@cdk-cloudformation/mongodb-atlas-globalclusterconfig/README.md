...
* Issues related to `MongoDB::Atlas::GlobalClusterConfig` should be reported to the [publisher](https://github.com/aws-cloudformation/aws-cloudformation-rpdk.git).
