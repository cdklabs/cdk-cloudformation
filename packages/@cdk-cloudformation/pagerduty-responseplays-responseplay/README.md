...
> AWS CDK [L1 construct] and data structures for the [AWS CloudFormation Registry] type `PagerDuty::ResponsePlays::ResponsePlay` v1.4.0.
...
* Issues related to this generated library should be [reported here](https://github.com/cdklabs/cdk-cloudformation/issues/new?title=Issue+with+%40cdk-cloudformation%2Fpagerduty-responseplays-responseplay+v1.4.0).
